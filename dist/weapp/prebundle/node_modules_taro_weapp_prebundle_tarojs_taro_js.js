    ...
    "node_modules/@tarojs/api/dist/interceptor/chain.js" () {
        ...
        Chain = class _Chain {
            proceed(requestParams = {}) {
                ...
                Object.keys(p).forEach((k)=>(0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(p[k]) && (res[k] = p[k]));
                return res;
            }
            _getNextInterceptor() {
...
function timeoutInterceptor(chain) {
    ...
    if (!(0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.isUndefined)(p) && (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(p.abort)) res.abort = p.abort;
    return res;
}
function logInterceptor(chain) {
    ...
    if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(p.abort)) res.abort = p.abort;
    return res;
}
...
function getPreload(current) {
    return function(key, val) {
        current.preloadData = (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(key) ? key : {
            [key]: val
        };
    };
}
...
function getPxTransform(taro) {
    return function(size) {
        ...
        const designWidth = ((input = 0)=>(0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(config.designWidth) ? config.designWidth(input) : config.designWidth || defaultDesignWidth)(size);
...
var init_dist3 = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_2__.__esm)({
    "node_modules/@tarojs/api/dist/index.js" () {
        ...
        Taro = {
            ...
            Current: _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.Current,
            getCurrentInstance: _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.getCurrentInstance,
            options: _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.options,
            nextTick: _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.nextTick,
            eventCenter: _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.eventCenter,
            Events: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_1__.Events,
            getInitPxTransform,
            interceptorify
        };
        Taro.initPxTransform = getInitPxTransform(Taro);
        Taro.preload = getPreload(_chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.Current);
...
var require_taro = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_2__.__commonJS)({
    "node_modules/@tarojs/taro/index.js" (exports, module) {
        var { hooks } = ((0,_chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.init_dist)(), (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_2__.__toCommonJS)(_chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_0__.dist_exports));
