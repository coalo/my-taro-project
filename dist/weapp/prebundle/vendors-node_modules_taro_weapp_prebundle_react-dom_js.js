...
function updatePropsByPayload(dom, oldProps, updatePayload) {
    ...
    for(let i = 0; i < updatePayload.length; i += 2){
        ...
        if ("mini" === _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY) {
            if (key === "__fixed") {
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_BUHVOZRY_js__WEBPACK_IMPORTED_MODULE_0__.FormElement;
    for(i in newProps){
        if (oldProps[i] !== newProps[i] || isFormElement && i === "value") {
            if (i === "style" && (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(oldProps[i]) && (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(newProps[i]) && isEqual(oldProps[i], newProps[i])) continue;
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.capitalize)((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && "mini" !== _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY && compName in _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
        if (oldValue) {
            dom.removeEventListener(eventName, oldValue, "mini" !== _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY ? false : void 0);
            dom.addEventListener(eventName, value, "mini" !== _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY ? {
                isCapture,
                sideEffect: false
            } : void 0);
        } else {
            dom.addEventListener(eventName, value, "mini" !== _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY ? isCapture : void 0);
        }
    } else {
...
function setStyle(style, key, value) {
    if (key[0] === "-" && "mini" !== _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY) {
        style.setProperty(key, value.toString());
        return;
    }
    style[key] = (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? "mini" === _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY ? value + "px" : (0,_chunk_BUHVOZRY_js__WEBPACK_IMPORTED_MODULE_0__.convertNumber2PX)(value) : value === null ? "" : value;
}
function setHarmonyStyle(dom, value, oldValue) {
    const style = dom._st.hmStyle;
    if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(oldValue)) {
    ...
    if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(value)) {
...
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(oldValue)) {
                for(const i in oldValue){
                    if (!(value && i in value)) {
                        if ("mini" === _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY && i === "position" && oldValue[i] === "fixed") {
                            dom.setLayer(0);
                        }
                        setStyle(style, i, "");
                    }
            ...
            if ((0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(value)) {
                for(const i in value){
                    if (!oldValue || !isEqual(value[i], oldValue[i])) {
                        if ("mini" === _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_TYPE.HARMONY && i === "position") {
                            if (value[i] === "fixed" || value[i] !== "fixed" && (oldValue === null || oldValue === void 0 ? void 0 : oldValue[i])) {
                                dom.setLayer(value[i] === "fixed" ? 1 : 0);
                            }
                        }
    ...
    } else if (!(0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_BUHVOZRY_js__WEBPACK_IMPORTED_MODULE_0__.taroDocumentProvider.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_BUHVOZRY_js__WEBPACK_IMPORTED_MODULE_0__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_BUHVOZRY_js__WEBPACK_IMPORTED_MODULE_0__.taroDocumentProvider.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    afterActiveInstanceBlur: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    preparePortalMount: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    prepareScopeUpdate: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    ...
    resetTextContent: _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_AXN6CDIK_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
