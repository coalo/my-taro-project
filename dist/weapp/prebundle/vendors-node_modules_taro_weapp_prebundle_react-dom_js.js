...
/* harmony import */ var _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-4MNUZVLC.js */ "./node_modules/.taro/weapp/prebundle/chunk-4MNUZVLC.js");
/* harmony import */ var _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-HD2FKCVL.js */ "./node_modules/.taro/weapp/prebundle/chunk-HD2FKCVL.js");
...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-4MNUZVLC.js */ "./node_modules/.taro/weapp/prebundle/chunk-4MNUZVLC.js")["nav"];
...
(0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.init_dist)();
(0,_chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__.init_dist)();
...
function updatePropsByPayload(dom, oldProps, updatePayload) {
    ...
    for(let i = 0; i < updatePayload.length; i += 2){
        ...
        if ("mini" === _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY) {
            if (key === "__fixed") {
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
        if (oldProps[i] !== newProps[i] || isFormElement && i === "value") {
            if (i === "style" && (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldProps[i]) && (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(newProps[i]) && isEqual(oldProps[i], newProps[i])) continue;
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.capitalize)((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && "mini" !== _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY && compName in _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (oldValue) {
            dom.removeEventListener(eventName, oldValue, "mini" !== _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? false : void 0);
            dom.addEventListener(eventName, value, "mini" !== _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? {
                isCapture,
                sideEffect: false
            } : void 0);
        } else {
            dom.addEventListener(eventName, value, "mini" !== _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? isCapture : void 0);
        }
    } else {
...
function setStyle(style, key, value) {
    if (key[0] === "-" && "mini" !== _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY) {
        style.setProperty(key, value.toString());
        return;
    }
    style[key] = (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? "mini" === _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? value + "px" : (0,_chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__.convertNumber2PX)(value) : value === null ? "" : value;
}
function setHarmonyStyle(dom, value, oldValue) {
    const style = dom._st.hmStyle;
    if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
    ...
    if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
...
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
                for(const i in oldValue){
                    if (!(value && i in value)) {
                        if ("mini" === _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY && i === "position" && oldValue[i] === "fixed") {
                            dom.setLayer(0);
                        }
                        setStyle(style, i, "");
                    }
            ...
            if ((0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
                for(const i in value){
                    if (!oldValue || !isEqual(value[i], oldValue[i])) {
                        if ("mini" === _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY && i === "position") {
                            if (value[i] === "fixed" || value[i] !== "fixed" && (oldValue === null || oldValue === void 0 ? void 0 : oldValue[i])) {
                                dom.setLayer(value[i] === "fixed" ? 1 : 0);
                            }
                        }
    ...
    } else if (!(0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__.taroDocumentProvider.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_4MNUZVLC_js__WEBPACK_IMPORTED_MODULE_1__.taroDocumentProvider.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    afterActiveInstanceBlur: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    preparePortalMount: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    prepareScopeUpdate: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    resetTextContent: _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_HD2FKCVL_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
